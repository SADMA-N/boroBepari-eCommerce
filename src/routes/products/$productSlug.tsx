      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-12">
        ...
        <div className="lg:col-span-1">
          ...
          {product.hasSample && !isOutOfStock && (
            <div
              className="mb-6 flex items-center justify-between border p-3 rounded-lg hover:border-blue-400 transition-colors cursor-pointer"
            ...
            >
              ...
              <div
                className={`w-10 h-6 flex items-center bg-gray-300 rounded-full p-1 duration-300 ease-in-out ${isSample ? 'bg-blue-600' : ''}`}
              >
                <div
          ...
          <div className="space-y-4">
            ...
            <button
              ...
              className="w-full bg-white border-2 border-blue-600 text-blue-600 py-3 px-4 rounded-lg font-bold hover:bg-blue-50 transition flex items-center justify-center"
            >
              ...
              <dl className="grid grid-cols-1 sm:grid-cols-2 gap-x-4 gap-y-4">
                {product.specifications?.map((spec, idx) => (
                  <div key={idx} className="flex border-b border-gray-200 pb-2">
                    <dt className="w-1/3 text-gray-500 text-sm font-medium">
                      {spec.key}
                    </dt>
