    ...
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950">
      ...
      <div className="relative overflow-hidden">
        ...
        <div className="relative max-w-5xl mx-auto px-4 py-12 space-y-8">
          <div className="bg-white/90 dark:bg-slate-900/90 backdrop-blur rounded-2xl border dark:border-slate-800 shadow-sm p-8 text-center">
            <div className="mx-auto mb-5 w-20 h-20 rounded-full bg-emerald-100 dark:bg-emerald-900/30 flex items-center justify-center">
              <CheckCircle
                className="w-10 h-10 text-emerald-600"
                strokeWidth={2.4}
              />
            </div>
            <p className="text-emerald-700 dark:text-emerald-400 text-sm font-semibold tracking-wide uppercase">
            ...
            <div className="mt-6 flex flex-wrap justify-center gap-3">
              <button
                className="inline-flex items-center gap-2 rounded-full border border-slate-200 dark:border-slate-700 px-4 py-2 text-sm font-medium text-slate-700 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-slate-800"
              ...
              <Link
                ...
                className="inline-flex items-center gap-2 rounded-full bg-slate-900 dark:bg-slate-100 px-5 py-2 text-sm font-semibold text-white dark:text-slate-900 hover:bg-slate-800 dark:hover:bg-slate-200"
              >
                Track Order
              </Link>
            </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            <div className="lg:col-span-2 space-y-6">
              <div className="bg-white dark:bg-slate-900 rounded-2xl border dark:border-slate-800 shadow-sm p-6">
                ...
                <div className="mt-4 grid gap-4 md:grid-cols-3 text-sm">
                  {[
                    ...
                    <div
                      key={idx}
                      className="rounded-xl border border-slate-100 dark:border-slate-800 bg-slate-50/70 dark:bg-slate-800/50 p-4"
                    >
                      <step.icon className="text-emerald-600" size={18} />
                      <h3 className="mt-3 font-semibold text-slate-900 dark:text-white">
                        {step.title}
                      </h3>
                      <p className="mt-2 text-slate-600 dark:text-slate-400">{step.detail}</p>
                    </div>
                  ))}
                </div>
              </div>
              ...
              <div className="bg-white dark:bg-slate-900 rounded-2xl border dark:border-slate-800 shadow-sm overflow-hidden">
                <div className="px-6 py-4 border-b dark:border-slate-800 bg-slate-50 dark:bg-slate-800">
            ...
            <div className="space-y-6">
              <div className="bg-white dark:bg-slate-900 rounded-2xl border dark:border-slate-800 shadow-sm p-6 space-y-4">
                <div>
                ...
                {isEscrow && (
                  <div className="rounded-xl border border-blue-100 dark:border-blue-900/30 bg-blue-50 dark:bg-blue-950/20 p-4 text-sm text-blue-700 dark:text-blue-400">
                ...
                {isDeposit && balanceDue > 0 && (
                  <div className="rounded-xl border border-amber-100 dark:border-amber-900/30 bg-amber-50 dark:bg-amber-950/20 p-4 text-sm text-amber-700 dark:text-amber-400">
                ...
                <div className="grid gap-3">
                  <Link
                    to={`/buyer/orders/${order.id}`}
                    className="w-full rounded-lg bg-slate-900 dark:bg-slate-100 py-2.5 text-center text-sm font-semibold text-white dark:text-slate-900 hover:bg-slate-800 dark:hover:bg-slate-200"
                  >
                    Track Order
                  </Link>
                  <button className="w-full rounded-lg border border-slate-200 dark:border-slate-700 py-2.5 text-center text-sm font-semibold text-slate-700 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-slate-800">
              ...
              <div className="bg-white dark:bg-slate-900 rounded-2xl border dark:border-slate-800 shadow-sm p-6">
                ...
                <div className="mt-4 flex flex-wrap gap-2 text-sm">
                  <button
                    className="rounded-full border border-slate-200 dark:border-slate-700 px-3 py-1.5 text-slate-700 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-slate-800"
