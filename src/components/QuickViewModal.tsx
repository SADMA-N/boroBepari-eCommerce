            ...
            <div className="mt-8 pt-6 border-t border-gray-100 space-y-3">
              <div className="flex gap-3">
                <button
                  ...
                  disabled={isOutOfStock}
                  className="flex-1 flex items-center justify-center gap-2 bg-orange-600 text-white py-3.5 rounded-xl font-bold text-lg hover:bg-orange-700 active:scale-[0.98] transition-all disabled:opacity-50 disabled:cursor-not-allowed shadow-lg shadow-orange-200"
                >
                ...
                <button
                  ...
                  className="px-4 py-3.5 border-2 border-orange-100 text-orange-600 rounded-xl font-bold hover:bg-orange-50 active:scale-[0.98] transition-all flex items-center justify-center"
                  title="Request Quote"
                >
